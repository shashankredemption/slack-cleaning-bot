...
def slack_cleaning_bot():
    ...
    david_message = sendgrid.Mail(to='david@dtbui.com', subject='👀 good shit go౦ԁ sHit👌 thats ✔ some good👌shit right👌there👌👌 rightthere ✔if i do ƽaү so my self', html='<strong> IT IS YOUR LUCKY DAY MOTHAFUCKA </strong>', text="It's" + str(people[day_of_year%6]) + "'s turn to clean the dishes!", from_email="shashank@thenothing.co")
